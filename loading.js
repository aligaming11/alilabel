...
// Simulate realistic loading process
function simulateRealisticLoading() {
    ...
    function updateProgress() {
        ...
        if (progressValue >= 25 && stepIndex === 0) {
            stepIndex = 1;
            updateSteps();
        } else if (progressValue >= 50 && stepIndex === 1) {
            stepIndex = 2;
            updateSteps();
        } else if (progressValue >= 75 && stepIndex === 2) {
            stepIndex = 3;
            updateSteps();
        }
        ...
        if (progressValue < 100) {
            ...
            setTimeout(() => {
                window.location.href = "http://quickconnect.to/aliss202";
            }, 500);
        }
    }
